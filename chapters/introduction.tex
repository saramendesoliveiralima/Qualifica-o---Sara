...
\begin{itemize}
  ...
  %Refere-se ao Estudo Experimental. Esta etapa contempla a execução de um estudo experimental cujo objetivo principal é compreender quais são as técnicas de teste de regressão implementadas por ferramentas disponíveis mais adequadas para projetos de \ac{APPS} Android.% 

...
\begin{itemize}
    ...
    \begin{figure}[!htb]
    \centering
    \includegraphics[width=.55\textwidth]{images/s_jferramentasexpectativas.png}
    ...
    \begin{figure}[!htb]
    \centering
    \includegraphics[width=.55\textwidth]{images/featuresfmanutencao.png}
    ...
    \begin{figure}[!htb]
    \centering
    \includegraphics[width=.55\textwidth]{images/s_jfeaturesexistentes.png}
